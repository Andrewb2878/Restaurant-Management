...
SECRET_KEY = 'django-insecure-8#8_s$g=jyc@t=v1(^g%l6ss4+b)bv$#&$9erq%l904e##m5(*'
...
# Path to store static files (optional but recommended for production)
STATICFILES_DIRS = [
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'mutluluk.derby@gmail.com'
EMAIL_HOST_PASSWORD = 'eqhg ldfs meop pkzg'
